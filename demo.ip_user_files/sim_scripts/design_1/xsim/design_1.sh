...
#
# Script generated by Vivado on Wed Oct 09 18:30:18 IST 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/arx-0/Xilinx_installs/vitis_unified/Vivado/2023.1/data/xsim"
  fi
